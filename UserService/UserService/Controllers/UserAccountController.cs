...
namespace UserService.Controllers
{
    ...
    public class UserAccountController : Controller
    {
        ...
        [HttpPost]
        [AllowAnonymous]
        [SwaggerResponse(statusCode: 201, description: "User account created successfully", type: typeof(IdentityDto))]
        ...
        public IActionResult CreateUserAccount([FromBody] UserCreateDto newUserAccount)
        {
            ...
            IdentityDto createdAccount = userAccountService.CreateUserAccount(newUserAccount);
        ...
        [HttpPost("login")]
        [AllowAnonymous]
        [SwaggerResponse(statusCode: 200, description: "Successfull operation", type: typeof(TokenDto))]
        [SwaggerResponse(statusCode: 400, description: "Given input is invalid", type: typeof(ErrorResponseDto))]
        ...
        public IActionResult Login([FromBody] UserLogInDto userLogIn)
        {
            ...
            TokenDto accessToken = userAccountService.AuthenticateUser(userLogIn);
        ...
        public IActionResult UpdateUserAccountById ([FromRoute] Guid id, [FromBody] UserUpdateDto userAccount)
        {
            ...
            userAccountService.UpdateAccount(id, userAccount);
        ...
        public IActionResult VerifyUserId(Guid userId)
        {
            ...
            userAccountService.IsUserExists(userId);

...
namespace UserServiceTests.Controllers
{
    public class UserPaymentTests
    {
        ...
        {
            ILogger<UserPaymentRepo> loggerUserPaymentRepo = new Mock<ILogger<UserPaymentRepo>>().Object;

            IUserPaymentRepository userPaymentRepo = new UserPaymentRepo(context, loggerUserPaymentRepo);

...
namespace UserServiceTests.Controllers
{
    public class UserAddressTests
    {
        ...
        {
            ILogger<UserAddressRepo> loggerUserAddressRepo = new Mock<ILogger<UserAddressRepo>>().Object;

            IUserAddressRepository userAddressRepo = new UserAddressRepo(context, loggerUserAddressRepo);
            ...
            ILogger<UserAccountRepo> loggerUserAccountRepo = new Mock<ILogger<UserAccountRepo>>().Object;
            IUserAccountRepository userAccountRepository = new UserAccountRepo(context, loggerUserAccountRepo);
        ...
        public void CreateAddress_WhenCreatedWithValidAddressAndUserId_Returns201StatusWithIdentityResponseDto()
        {
            ...
            createdResult.Value.Should().BeOfType<IdentityDto>();
        }

...
namespace Repository
{
    ...
    /// </summary>
    public class UserAddressRepo : IUserAddressRepository
    {
        private readonly RepositoryContext context;
        private readonly ILogger<UserAddressRepo> logger;

        public UserAddressRepo(RepositoryContext context, ILogger<UserAddressRepo> logger)
        {

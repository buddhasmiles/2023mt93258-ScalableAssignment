...
namespace Repository
{
    ...
    public class UserPaymentRepo : IUserPaymentRepository
    {
        ...
        private readonly ILogger<UserPaymentRepo> logger;

        public UserPaymentRepo(RepositoryContext context, ILogger<UserPaymentRepo> logger)
        {
        ...
        /// <returns></returns>
        public bool IsPaymentExists(Guid userId, string? name = null, string? paymentValue = null)
        {

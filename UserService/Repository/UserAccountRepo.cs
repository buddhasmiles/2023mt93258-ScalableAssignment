...
namespace Repository
{
    ...
    /// </summary>
    public class UserAccountRepo : IUserAccountRepository
    {
        private readonly RepositoryContext context;
        private readonly ILogger<UserAccountRepo> logger;

        public UserAccountRepo(RepositoryContext context, ILogger<UserAccountRepo> logger)
        {
        ...
        public void AddUser(User userAccount)
        {

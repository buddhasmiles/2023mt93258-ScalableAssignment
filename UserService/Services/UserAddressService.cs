...
namespace Services
{
    public class UserAddressService : IUserAddressService
    {
        ...
        /// <returns></returns>
        public IdentityDto CreateAddress(Guid userId, AddressCreateDto address)
        {
            ...
            userAddressRepository.AddAddress(customerAddress);
            ...
            return new IdentityDto { Id = customerAddress.Id };
        }
